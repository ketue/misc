...
public class GuavaOptional {
     ...
     */
    private final static Logger LOGGER = LoggerFactory.getLogger(GuavaOptional.class.getCanonicalName());
    ...
    public Optional<BigDecimal> getQuotient(final BigDecimal dividend, final BigDecimal divisor) {
        ...
        try {
            ...
            LOGGER.error("Unable to divide " + dividend + " by " + divisor + "-", ex);
            quotient = null;
        }
